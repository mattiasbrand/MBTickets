window.JSON || (window.JSON = { }), function() {
    ...
    c.Adapter = {
        handlers: { },
        _uid: 1,
        uid: function(a) { return a._uid || (a._uid = c.Adapter._uid++); },
        bind: function(a, b, d) {
            var e = c.Adapter.uid(a);
            c.Adapter.handlers[e] = c.Adapter.handlers[e] || { }, c.Adapter.handlers[e][b] = c.Adapter.handlers[e][b] || [], c.Adapter.handlers[e][b].push(d), a["on" + b] = function(a, b) { return function(d) { c.Adapter.trigger(a, b, d); }; }(a, b);
        },
        ...
        onDomLoad: function(b) {
            var c = a.setTimeout(function() { b(); }, 2e3);
            a.onload = function() { clearTimeout(c), b(); };
        }
    ...
    g.initHtml4 = function() {
        ...
        g.initHtml4.initialized = !0, g.enabled = !0, g.savedHashes = [], g.isLastHash = function(a) {
            ...
            return c = a === b, c;
        }, g.saveHash = function(a) { return g.isLastHash(a) ? !1 : (g.savedHashes.push(a), !0); }, g.getHashByIndex = function(a) {
            var b = null;
