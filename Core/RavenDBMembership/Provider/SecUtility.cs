...
namespace RavenDBMembership.Provider
{
    ...
    {
        internal static bool ValidateParameter(ref string param, bool checkForNull, bool checkIfEmpty,
                                            ...
                                            int maxSize, string paramName)
        {
            ...
            else
            {
                ...
                {
                    throw new ArgumentException(SR.Parameter_can_not_contain_comma_1.WithParameters(paramName),
                                                paramName);
                }
            }
        }
