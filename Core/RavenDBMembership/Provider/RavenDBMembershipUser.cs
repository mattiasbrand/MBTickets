...
{
    internal class RavenDBMembershipUser : MembershipUser
    {
        public RavenDBMembershipUser(string providerName, string username, string id, string email,
                                     string passwordQuestion, string comment, bool isApproved, bool isLockedOut,
                                     DateTime creationDate, DateTime lastLoginDate, DateTime lastActivityDate,
                                     DateTime lastPasswordChangedDate, DateTime lastLockoutDate)
            : base(
                providerName, username, id, email, passwordQuestion, comment, isApproved, isLockedOut, creationDate,
